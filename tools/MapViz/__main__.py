...
from mapViz.Helpers.helpers import create_logger, dict2str
from mapViz.Helpers.magic_gui_numbers import default_image_name
from mapViz.Helpers.default_map import default_image


from mapViz.Canvas.canvas import ImageView
from mapViz.Left_Menu.left_menu import LeftMenu
from mapViz.Paint_Menu.paint_menu import PaintMenu
from mapViz.Waypoint_Menu.waypoint_menu import WaypointMenu
...
class MainWindow(QMainWindow):
    def __init__(self, image, input_path):
        ...
        self.mapviz_logo = QLabel()
        self.mapviz_logo.setStyleSheet("background-image : url(Images/mapviz_logo.png)")

        self.waypoint_logo = QLabel()
        wp_logo = QPixmap('Images/waypoint_logo.png').scaled(100, 100)
        ...
        self.main_layout.addWidget(self.mapviz_logo, 0, 0)
